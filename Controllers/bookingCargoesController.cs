...
namespace CargoManagement.Controllers
{
    ...
    public class bookingCargoesController : Controller
    {
       ...
       // [Authorize(Roles ="Customer")]
        ...
        public ActionResult Create([Bind(Include = "booking_id,customer_id,product_id,quantity,booking_date")] bookingCargo bookingCargo)
        {
            ...
            ViewBag.customer_Name = new SelectList(db.customers, "customer_id", "customer_name", bookingCargo.customer_id);
            ViewBag.product_Name = new SelectList(db.products, "product_id", "product_name", bookingCargo.product_id);
            return View(bookingCargo);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "booking_id,customer_id,product_id,quantity,booking_date")] bookingCargo bookingCargo)
        {
            if (ModelState.IsValid)
            {
